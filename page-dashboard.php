	...
	<div class="columns medium-4 page-main-content">
		...
		<div class="company-info">
			<div class="columns medium-4">
				...
				<a href="/business-information/?gform_post_id=<?php echo $business_id; ?>&user-image=<?php echo urlencode($user_image); ?>&business-logo=<?php echo urlencode($business_image); ?>" class="small-link">Edit</a>
			</div>
